package dishonoredMod.cards;

import basemod.abstracts.CustomCard;
import dishonoredMod.DishonoredMod;
import dishonoredMod.util.CardInfo;
import com.megacrit.cardcrawl.cards.AbstractCard;
import com.megacrit.cardcrawl.core.CardCrawlGame;
import com.megacrit.cardcrawl.localization.CardStrings;

import static dishonoredMod.DishonoredMod.makeID;
import static dishonoredMod.util.TextureLoader.getCardTextureString;
    ...
    public void upgrade()
    {
        if (!upgraded)
        {
            ...
            if (this.upgradesDescription)
            {
                ...
                {
                    DishonoredMod.logger.error("Card " + cardID + " upgrades description and has null upgrade description.");
                }
                else
                {
